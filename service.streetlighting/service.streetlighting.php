				...
				<div class="col-lg">
					<div class="card">
						<div class="card-header">
							<h3 class="text-center">Street Lighting Under Anwara Union Council</h3>
						</div>
						<div class="card-body">
							<table class="table">
								<tr>
								...
								<tr>
									...
									<td><?php echo $i++; ?></td>
									<td><?php echo $blogs['rname'] ?></td>
									<td><?php echo $blogs['lnumber'] ?></td>
									
									<td><?php echo $blogs['color'] ?></td>
