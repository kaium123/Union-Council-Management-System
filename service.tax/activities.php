				...
				<div class="col-lg">
					<form method="post" enctype="multipart/form-data">
						<div class="form-group w-50">
							<label class="">Chairman Name :</label>
							<input type="text" name="cname" class="form-control">
						</div>
						<div class="form-group w-50">
							<label class="">Educational Background :</label>
							<input type="text" name="eback" class="form-control">
						</div>
						...
						<div class="form-group w-50">
							...
							<input type="" name="jdate" class="form-control">
						</div>
						<div class="form-group w-50">
							<label class="">Expire Date :</label>
							<input type="" name="edate" class="form-control">
						</div>
