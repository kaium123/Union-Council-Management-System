			...
			<div class="row">
				<div class="col-lg">
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form-group w-50">
							<label class="">Fathers Name :</label>
							<input type="text" name="fname" class="form-control">
						</div>
						<div class="form-group w-50">
							<label class="">Mothers Name :</label>
						...
						<div class="form-group w-50">
							...
							<input type="" name="nid" class="form-control">
						</div>
						<div class="form-group w-50">
							<label class="">Secret Code :</label>
							<input type="" name="scode" class="form-control">
						</div>
