				...
				<div class="col-lg">
					<div class="card">
						<div class="card-header">
							<h3 class="text-center">About Ward of Anwara Union Council</h3>
						</div>
						<div class="card-body">
							<table class="table">
								<tr>
									...
									<th>Word No</th>
									<th>Word Name</th>
									<th>Number of Schoole</th>
									<th>Number of College</th>
									<th>Number of Madrasha</th>
									<th>Number of temple</th>
									<th>Number of Mosjid</th>
								...
								<?php $i=1; while($blogs=mysqli_fetch_assoc($infor)) { ?>
								<tr>

									<td><?php echo $i++; ?></td>
									<td><?php echo $blogs['wardno'] ?></td>
									<td><?php echo $blogs['wname'] ?></td>
									
									<td><?php echo $blogs['school'] ?></td>
									<td><?php echo $blogs['college'] ?></td>
									<td><?php echo $blogs['madrasha'] ?></td>
									<td><?php echo $blogs['temple'] ?></td>
									<td><?php echo $blogs['mosjid'] ?></td>
									<td><?php echo $blogs['hospital'] ?></td>
									<td><?php echo $blogs['clinic'] ?></td>
									<td><?php echo $blogs['location'] ?></td>
						...
						<div class="card-footer">
							<h5 class="text-center">Saty Home,Stay Safe.</h5>
						</div>
					</div>
				</div>
			</div>
