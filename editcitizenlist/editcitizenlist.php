<?php
	...
	$information=$blog->editcitizen($_GET['id']);
	
	$info=mysqli_fetch_assoc($information);
	if(isset($_POST['btn'])){
		
		$message=$blog->updatecitizen($_GET['id']);
	}
	//$infor=$blog->viewcitizens();
	$result=7;
	$id=$result;
			...
			<div class="col-lg-8">
				...
				<div class="card">
					<div class="card-header">
						...
						<a href="../citizenslist/citizenslist.php" class=" float-right">Go Back</a>
					</div>
					<div class="card-body">
						<form method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" name="fname" class="form-control" value="<?php echo $info['fname'] ?>">
							</div>
							<div class="form-group">
								<label>Last Name</label>
								<input type="text" name="mname" class="form-control" value="<?php echo $info['mname'] ?>">
							</div>
							<div class="form-group">
								<label>Address</label>
							...
							<div class="form-group">
								<label>NID</label>
								<input type="text" name="nid" class="form-control" value="<?php echo $info['nid'] ?>">
							</div>
							<div class="form-group">
								<label>Secret Code</label>
								<input type="text" name="scode" class="form-control" value="<?php echo $info['scode'] ?>">
							</div>
