...
<html>
	...
	<body>
			...
			<div class="row">
				<div class="col-lg">
					<form method="post" enctype="multipart/form-data">
						...
						<div class="form-group w-50">
							<label class="">Ward Name :</label>
							<input type="text" name="wname" class="form-control">
						</div>
						<div class="form-group w-50">
							<label class="">Number of School :</label>
							<input type="text" name="school" class="form-control">
						</div>
						<div class="form-group w-50">
							<label class="">Number of College :</label>
							<textarea name="college" class="form-control"></textarea>
						</div>
						<div class="form-group w-50">
							<label class="">Number of madrasha :</label>
							<input type="text" name="madrasha" class="form-control">
						</div>
						<div class="form-group w-50">
							<label class="">Number of temple :</label>
							<textarea name="temple" class="form-control"></textarea>
						</div>
						<div class="form-group w-50">
							<label class="">Number of mosjid :</label>
							<input type="text" name="mosjid" class="form-control">
						</div>
						<div class="form-group w-50">
							<label class="">Number of Hospital :</label>
							<textarea name="hospital" class="form-control"></textarea>
						</div>
						<div class="form-group w-50">
							<label class="">Number of Clinic :</label>
		...
		<div class="navbar navbar-expand-md navbar-dark bg-dark justify-center sticky-bottom">
			<div class="mx-auto">
				<div class="ml-5">
