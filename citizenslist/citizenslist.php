			...
			<div class="col-lg-10">
				<div class="card">
					<div class="card-header">
						<span class="h3">Citizens List</span>
					...
					<div class="card-body">
						<table class="table">
							...
							<tr>
								...
								<td><?php echo $blogs['fname'] ?></td>
								<td><?php echo $blogs['mname'] ?></td>
								<td><?php echo $blogs['address'] ?></td>
								<td><img src="<?php echo $blogs['image'] ?>" alt="" width="100" height="100"></td>
								<td><?php echo $blogs['nid'] ?></td>
								<td><?php echo $blogs['scode'] ?></td>
								
								<td>
									<a href="../editcitizenlist/editcitizenlist.php?id=<?php echo $blogs['id'] ?>" class="btn btn-info btn-sm">Edit</a>
