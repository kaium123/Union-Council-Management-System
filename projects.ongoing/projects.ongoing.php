				...
				<div class="col-lg">
					<div class="card">
						<div class="card-header">
							<h3 class="text-center">On going projects of Anwara Union Council</h3>
						</div>
						<div class="card-body">
							<table class="table">
								<tr>
								...
								<tr>
									...
									<td><?php echo $i++; ?></td>
									<td><?php echo $blogs['pname'] ?></td>
									<td><?php echo $blogs['about'] ?></td>
									
									<td><?php echo $blogs['budget'] ?></td>
									<td><?php echo $blogs['location'] ?></td>
									<td><?php echo $blogs['sdate'] ?></td>
									<td><?php echo $blogs['edate'] ?></td>
